function createUnityInstance(t, n, c) {
    ...
    l.SystemInfo = function() {
        ...
        var u, l = {
            ...
            "NT 6.3": "8.1",
            "NT 10.0": "10"
        }[l] || l, h = ((h = document.createElement("canvas")) && (u = (f = h.getContext("webgl2")) ? 2 : 0,
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (h < d)
                        return u.slice(0, h);
                    for (var t = new Uint8Array(h), n = (t.set(u, 0),
                    f), r = 0; r < l.length; ++r)
                        t.set(l[r], n),
                        n += l[r].length;
                    return t
    ...
    function(o, a) {
        ...
        function d(n, r) {
            return fetch(n, r).then(function(e) {
                ...
                S(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
                    ...
                    e
                })) : (x("'" + s + "' request failed with status: " + e.status + " " + e.statusText),
        ...
        c.enabled ? i.loadRequest(s).then(function(e) {
            ...
            return x("Failed to load '" + c.metaData.url + "' from indexedDB cache due to the error: " + e),
            y(o, a)
        }) : y(o, a)
    }
    );
                ...
                try {
                    for (var n in E) {
                        ...
                        if (E[n].hasUnityMarker(i))
                            ...
                            (r = E[n]).worker || (o = URL.createObjectURL(new Blob(["this.require = ", r.require.toString(), "; this.decompress = ", r.decompress.toString(), "; this.onmessage = ", function(e) {
                                e = {
                                    id: e.data.id,
